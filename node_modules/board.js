...
class Board {
  ...
  constructor(init_pos, toMove, castles, wkpos, bkpos, epsq, mcount, hmcount) {
    this.entity = init_pos || FEN.toBoardArray(FEN.INIT_FEN);
  ...
  threatens(sq1, sq2) {
    ...
    //TODO: currently returns false if the piece on sq2 has the same color
    let move = {
      start: sq1,
      end: sq2
    };
    ...
    switch (piece.toUpperCase()) {
      ...
      case "P": return isLegalPawn(piece, move, this);
    }
  }
